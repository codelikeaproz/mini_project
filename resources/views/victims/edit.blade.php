...
@section('title', 'Edit Victim - ' . $victim->full_name)
    ...
    <div class="row">
        <div class="col-12">
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                <h1 class="h3 mb-0 text-gray-800">Edit Victim Information</h1>
                <div class="d-sm-flex">
                    <a href="{{ route('victims.show', $victim->id) }}" class="btn btn-info shadow-sm mr-2">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Update Victim Information - {{ $victim->name }}</h6>
                </div>
                <div class="card-body">
                    <form action="{{ route('victims.update', $victim->id) }}" method="POST">
                                ...
                                <select class="form-control @error('incident_id') is-invalid @enderror"
                                    ...
                                    @foreach($incidents as $incident)
                                        <option value="{{ $incident->id }}"
                                                {{ old('incident_id', $victim->incident_id) == $incident->id ? 'selected' : '' }}>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text"
                                       ...
                                       id="name" name="name"
                                       value="{{ old('name', $victim->name) }}" required>
                                @error('name')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text"
                                       ...
                                       value="{{ old('contact_number', $victim->contact_number) }}"
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <textarea class="form-control @error('address') is-invalid @enderror"
                                          id="address" name="address" rows="2" required>{{ old('address', $victim->address) }}</textarea>
                                @error('address')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-control @error('injury_status') is-invalid @enderror"
                                    ...
                                    <option value="uninjured" {{ old('injury_status', $victim->injury_status) == 'uninjured' ? 'selected' : '' }}>Uninjured</option>
                                    <option value="minor_injury" {{ old('injury_status', $victim->injury_status) == 'minor_injury' ? 'selected' : '' }}>Minor Injury</option>
                                    <option value="major_injury" {{ old('injury_status', $victim->injury_status) == 'major_injury' ? 'selected' : '' }}>Major Injury</option>
                                    <option value="critical" {{ old('injury_status', $victim->injury_status) == 'critical' ? 'selected' : '' }}>Critical</option>
                                    <option value="deceased" {{ old('injury_status', $victim->injury_status) == 'deceased' ? 'selected' : '' }}>Deceased</option>
                                </select>
                                @error('injury_status')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-control @error('medical_attention_required') is-invalid @enderror"
                                    ...
                                    <option value="1" {{ old('medical_attention_required', $victim->medical_attention_required ? '1' : '0') == '1' ? 'selected' : '' }}>Yes</option>
                                    <option value="0" {{ old('medical_attention_required', $victim->medical_attention_required ? '1' : '0') == '0' ? 'selected' : '' }}>No</option>
                                </select>
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-3">
                                ...
                                <input type="text"
                                       ...
                                       value="{{ old('hospital_name', $victim->hospital_name) }}"
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text"
                                       ...
                                       value="{{ old('emergency_contact_name', $victim->emergency_contact_name) }}">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text"
                                       ...
                                       value="{{ old('emergency_contact_number', $victim->emergency_contact_number) }}"
                                       placeholder="e.g., 09123456789">
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-3">
                                ...
                                <textarea class="form-control @error('notes') is-invalid @enderror"
                                          ...
                                          placeholder="Any additional information about the victim or medical condition">{{ old('notes', $victim->notes) }}</textarea>
                                @error('notes')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="alert alert-light">
                            ...
                            <ul class="mb-0">
                                <li>Created: {{ $victim->created_at->format('F d, Y \a\t g:i A') }}</li>
                                @if($victim->updated_at && $victim->updated_at != $victim->created_at)
                                    <li>Last Updated: {{ $victim->updated_at->format('F d, Y \a\t g:i A') }}</li>
                                @endif
                            </ul>
                        </div>
                        ...
                        <div class="d-flex justify-content-between">
                            <a href="{{ route('victims.show', $victim->id) }}" class="btn btn-secondary">
                                <i class="fas fa-times"></i> Cancel
                            </a>
                            <button type="submit" class="btn btn-primary">
                                <i class="fas fa-save"></i> Update Victim Information
                            </button>
                        </div>
                    </form>
                </div>
